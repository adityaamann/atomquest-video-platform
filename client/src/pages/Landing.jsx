...
const features = [
  ...
  },
  {
    ...
    desc: 'Automated insights on every call — sentiment analysis, message breakdown, keywords, and call duration.',
  },
]
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="max-w-6xl mx-auto px-6 pt-20 pb-24 text-center page-enter">
        ...
        <p className="text-lg text-slate-500 max-w-2xl mx-auto mb-10 leading-relaxed">
          Real-time video calls, session recording, and AI-powered insights — all on your own infrastructure.
